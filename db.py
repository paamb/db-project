...
# Ikke endre
	...
	cursor.execute('''INSERT OR IGNORE INTO Kaffebrenneri VALUES (2, 'Coffee Supreme')''')
	...
	cursor.execute('''INSERT OR IGNORE INTO Kaffesmaking VALUES (3, 'Fruktig og floral men gir meg ikke noe mer', 10 ,'2022-03-02', 2, 3)''')
	cursor.execute('''INSERT OR IGNORE INTO Kaffesmaking VALUES (4, 'Litt for sterk', 10 ,'2022-03-02', 3, 4)''')
	cursor.execute('''INSERT OR IGNORE INTO Kaffesmaking VALUES (5, 'Kjenner at denne kaffen er vasket, noe jeg ikke er noe glad i', 10 ,'2022-03-02', 3, 5)''')
	cursor.execute('''INSERT OR IGNORE INTO Kaffesmaking VALUES (6, 'En opplevelse av rang, floral!', 10 ,'2022-03-02', 3, 6)''')
	cursor.execute('''INSERT OR IGNORE INTO Kaffesmaking VALUES (7, 'En veldig god kaffe', 10 ,'2022-03-02', 3, 7)''')
